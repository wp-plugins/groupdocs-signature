...
function grpdocs_signature_getdocument($atts) {
	...
	$code = '<iframe src="https://apps.groupdocs.com/signature2/forms/SignEmbed/'. $guid .'?referer=wordpress-signature/1.0.1" frameborder="0" width="'. $width .'" height="'. $height .'">' . $if_no_iframe . '</iframe>';
